# -*- coding: utf-8 -*-
"""Updating_yolo26-obb.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1n1QEb82t0sBUWImycHq7o1IAPbxQ4m2q

This script is used to update the existing yolo26-obb model with new vessel images
"""

from google.colab import drive
drive.mount('/content/drive')

PROJECT_DIR = "/content/drive/MyDrive/yolo26_phase1_training_v2"
!nvidia-smi
...
model = YOLO("/content/drive/MyDrive/yolo26_phase1_training_v1/yolo26m_obb_phase12/weights/best.pt")

model.train(
    data="/content/Ship-Detection-2-4/data.yaml",
    task="obb",
    epochs=5,
    imgsz=1024,
    batch=4,
    ...
    project="/content/drive/MyDrive/yolo26_phase1_training_v2",
    name="yolo26m_obb_phase1_updated"
)
...
test_results = model.predict(
    source="/content/Ship-Detection-2-4/test/images",
    task="obb",
    imgsz=1024,
    batch=4,
...
test_results = model.val(
    data="/content/Ship-Detection-2-4/data.yaml",  # YAML must have a 'test:' field
    task="obb",
    imgsz=1024,
    batch=4,
...
MODEL_NAME = "yolo26-obbv2"   # <- change per experiment
...
weights_path = "/content/drive/MyDrive/yolo26_phase1_training_v2/yolo26m_obb_phase1_updated2/weights/best.pt" # Change this to model path
zip_path = "/content/yolo26-obb_V2_best_weights.zip" # Change this name
...
# --- Paths ---
folder_to_zip = "/content/drive/MyDrive/yolo26_phase1_training_v2/yolo26m_obb_phase1_updated2" # CHANGE THIS
zip_output_path = "/content/yolo26m_obb_phase1_V2.zip"  # CHANGE THIS NAME
